...
import { round01, round02, round03, Create, wSec03, wSec05 } from '../../assets';
    ...
    <Inner>
      ...
      <section className='min-h-[70vh] px-[4%] pt-3.5 flex flex-col gap-1 overflow-hidden HeroC'>
        <div className='grid grid-cols-[60%_40%] gap-5 HContainer'>
          <motion.h1 className='text-5xl font-thin tracking-wide font-sans text-[#383636]'
            ...
            <div className='flex flex-col justify-center'>
              <div className='flex items-center space-x-1 my-2 HImg'>
                <div className='flex -space-x-2'>
                  <motion.img src={round01} alt='user' className='w-12 h-12 rounded-full '
                    initial={{ opacity: 0, y: 40 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
                  />
                  <motion.img src={round02} alt='user' className='w-12 h-12 rounded-full '
                    initial={{ opacity: 0, y: 40 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1.3 }}
                  />
                  <motion.img src={round03} alt='user' className='w-12 h-12 rounded-full '
                    initial={{ opacity: 0, y: 40 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1.6 }}
                  />
                  <motion.p className='w-12 h-12 rounded-full text-center bg-white flex items-center justify-center text-[#636363]'
                  initial={{ opacity: 0, y: 40 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 1.9 }}>+</motion.p>
                </div>
              </div>
      ...
      <ReactLenis root>
        ...
        <section className='min-h-[60vh] my-16 px-[4%]  flex flex-col gap-10' id='About'>
          <div className='flex justify-center'>
            <h1 className="text-6xl text-dark font-sans NPText ">
              <span className="flex items-start gap-2 autoshow">
              ...
              <span className="flex indent-12 autoshow">
              ...
              <span className="block indent-20 autoshow">Maximum Profit</span>
            </h1>
          </div>
          <div className='grid grid-cols-2 gap-4 Sec02'>
            ...
            <img  src={Create} className='rounded-md h-[400px] w-full object-cover autoshow'/>
          </div>
        </section>

        <section className='min-h-[60vh] my-16 px-[4%]  flex flex-col gap-4 justify-center wSec'>
          <div className='grid grid-cols-2 gap-3 wCSec'>
            <img 
              src={wSec05}
              loading='lazy'
              className='rounded-xl h-[450px] w-full object-fit autoshow'
            />
            <div className='min-h-[450px] bg-[#ebe7e7] rounded-xl py-2 px-2.5'>
              <h1 className='text-2xl text-dark font-sans'>
                Why Choose Us
              </h1>
              <motion.p className='text-[#303030] my-1.5'
                initial={{ opacity: 0, y: 40 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 1 }}
              ...
              <motion.div className="space-y-4 " id='Why Us'
                initial={{ opacity: 0, y: 40 }}
                whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className='grid grid-cols-[1fr_1fr_1fr_2fr] gap-2 WSCards'>
            <div className='flex flex-col gap-2 rounded-md bg-amber-200 p-2 space-y-2 autoshow'>
            ...
            <div className='flex flex-col gap-2 rounded-md bg-[#ebe7e7] p-2 space-y-2 autoshow'>
              <h2 className='text-xl'>
            ...
            <div className='relative bg-center rounded-md autoshow' style={{ backgroundImage: `url(${wSec03})`}}>
